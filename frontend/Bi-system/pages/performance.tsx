...
import TeacherAcademicPerformance from '../components/AcademicPerformance/TeacherAcademicPerformance';
      ...
      <main className="flex-1 overflow-y-auto p-4 md:p-8 transition-all duration-300 lg:ml-64">
        <div className="max-w-7xl mx-auto">
          <div className="mb-6 md:mb-8">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Успеваемость</h1>
          </div>
